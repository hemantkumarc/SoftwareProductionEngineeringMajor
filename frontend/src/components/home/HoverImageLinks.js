...
import './hoverImageLinksStyles.css'
  ...
  return (
    ...
    >
      <div>
        ...
        <span className="relative z-10 mt-2 block text-base text-neutral-500 transition-colors duration-500 group-hover:text-neutral-50 subHeadings">
          {subheading}
        </span>
      </div>
