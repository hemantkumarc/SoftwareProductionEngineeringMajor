...
function LoginTerminal() {
  ...
  const submitData = () => {
    axios
      .post("http://34.171.183.58:31995/signup", {
        username: email,
        password: password,
        name: name,
      })
    ...
    <section id="fullScreen">
      <div className="terminal-window">
        ...
        <div id="emailInput" className="row">
          <div id="emailPrec" className="col-4">
            Could you please provide
          </div>
          <div id="emailText" className="col-3">
            your email?
          </div>
        </div>
        ...
        {showEmail ? (
          <>
            <div id="inputEmail" className="row">
              ...
              <div id="userEmail" className="col-4">
                {email}
              </div>
            </div>

            <div className="row">
              <div className="col-4" id="preName">
                Awesome, may I get
              </div>
              <div className="col-3" id="userName">
                your name?
              </div>
            </div>
            ...
            {showName ? (
              <>
                <div id="inputName" className="row">
                  ...
                  <div id="nameUser" className="col-4">
                    {name}
                  </div>
                </div>
                <div className="row">
                  <div className="col-4" id="prePassword">
                    Finally... please provide a
                  </div>
                  <div className="col-3" id="passwordLabel">
                    strong password.
                  </div>
                </div>
                ...
                {showPassword ? (
                  ...
                  <div id="inputName" className="row">
                    <div className="col-1">
                      <img
                        id="arrow"
                        src={require("../../assets/right-arrow-2.png")}
                      />
                    </div>
                    <div className="col-1">
                      <img
                        id="tildeIcon"
                        src={require("../../assets/tilde-3.png")}
                      />
                    </div>
                    <div id="enterPassword" className="col-8">
                      Enter Password:
                      <input
                        type="text"
                        id="emailNameField"
              ...
              <div id="inputName" className="row">
                ...
                <div id="enterName" className="col-8">
                  Enter Name:
                  <input
                    type="text"
                    id="emailNameField"
          ...
          <div id="inputEmail" className="row">
            ...
            <div id="enterEmail" className="col-8">
              Enter Email:
              <input
                type="text"
                id="emailInputField"
